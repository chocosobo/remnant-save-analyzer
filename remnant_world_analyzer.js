    ...
    if (eventName != lastEventname) {
      // Replacements
        if (eventName != undefined) {
             ...
             .replace('MadMerchant', '미치광이 상인')
             .replace('TheRisen', '리애니메이터')
             .replace('LizAndLiz', '시카고 타자기')
             .replace('Fatty', '불결한 자')
             .replace('WastelandGuardian', '클라비거')
             .replace('RootEnt', '나무 정령')
             .replace('Wolf', '재해')
             .replace('RootDragon', '신지')
             .replace('SwarmMaster', '채찍꾼')
             .replace('RootWraith', '감싸인 자')
             .replace('RootTumbleweed', '난도꾼')
             .replace('Kincaller', '투기장 관리인')
             .replace('Tyrant', '노역꾼')
             .replace('Vyr', '뒤덮는 자와 분쇄자')
             .replace('ImmolatorAndZephyr', '방화자와 그슬음')
             .replace('RootBrute', '핏주먹')
             .replace('SlimeHulk', '궤양덩이')
             .replace('BlinkFiend', '맹공을 퍼붓는 자')
             .replace('Sentinel', '철거자')
             .replace('Penitent', '레토의 목걸이')
             .replace('LastWill', '돌격 소총')
             .replace('SwampGuardian', '이실리스')
             .replace('Splitter', '찢기는 가죽')
             .replace('Brabus', '브라버스')
             .replace('Hound Master', '폭군')
             .replace('Gunslingers Charm', '총잡이의 부적')
             .replace('Simulacrum', '시뮬라크럼')
             .replace('Pocket Watch', '회중시계')
             .replace('Mud Tooth', '머드투스')
             .replace('Wailing Wood', '울부짖는 나무')
             .replace('Stuck Merchant', '꼼짝않는 상인')
             .replace('The Lost Gantry', '잃어버린 지지대')
             .replace('Trait Book', '지식의 고서')
             .replace('Drifter Mask', '방랑자의 가면')
             .replace('The Harrow', '쟁쇠장이')
             .replace('Storm Caller', '폭풍을 부르는 자')
             .replace('Twisted Idol', '뒤틀린 우상')
             .replace('Galenic Charm', '갈레닉 부적')
             .replace('Brutal Mark', '야만의 표식')
             .replace('Cleansing Jewel', '정화의 보석')
             .replace('Menders Charm', '치유사의 부적')
             .replace('Rock of Anguish', '격통의 바위')
             .replace('Butchers Fetish', '도살자의 페티쉬')
             .replace('Storm Amulet', '폭풍의 목걸이')
             .replace('Vengeance Idol', '복수의 우상')
             .replace('Soul Anchor', '영혼의 닻')
             .replace('Scavengers Bauble', '고철 수집가의 싸구려 보석')
             .replace('Heart Seeker', '심장 추적기')
             .replace('Mothers Ring', '어머니의 반지')
             .replace('Pillar Of Stone', '돌 기둥')
             .replace('Ring Of Evasion', '회피의 반지')
             .replace('Sagestone', '현자의 돌')
             .replace('Braided Thorns', '꼬은 가시')
             .replace('Root Circlet', '뿌리의 관')
             .replace('Leech Ember', '거머리 잉걸불')
             .replace('Hunters Halo', '사냥꾼의 광륜')
             .replace('Gravity Stone', '중력의 돌')
             .replace('Ezlans Band', '에즐란의 띠')
             .replace('Band Of Strength', '힘의 띠')
             .replace('Jewel Of The Black Sun', '검은 태양의 보석')
             .replace('Blood Font', '피의 서약')
             .replace('Devouring Loop', '삼켜지는 고리')
             .replace('Razor Stone', '날카로운 돌')
             .replace('Stone Of Balance', '균형의 돌')
             .replace('Keepers Ring', '문지기의 반지')
             .replace('Hunters Band', '사냥꾼의 띠')
             .replace('Celerity Stone', '쾌속의 돌')
             .replace('Guardians Ring', '수호자의 반지')
             .replace('Heart Of The Wolf', '늑대의 심장')
             .replace('PocketWatch', '회중시계')
             .replace('MudTooth', '머드투스')
             .replace('WailingWood', '울부짖는 나무')
             .replace('StuckMerchant', '꼼짝않는 상인')
             .replace('TheLostGantry', '잃어버린 지지대')
             .replace('TraitBook', '지식의 고서')
             .replace('DrifterMask', '방랑자의 가면')
             .replace('TheHarrow', '쟁쇠장이')
             .replace('StormCaller', '폭풍을 부르는 자')
             .replace('TwistedIdol', '뒤틀린 우상')
             .replace('GalenicCharm', '갈레닉 부적')
             .replace('BrutalMark', '야만의 표식')
             .replace('CleansingJewel', '정화의 보석')
             .replace('MendersCharm', '치유사의 부적')
             .replace('RockOfAnguish', '격통의 바위')
             .replace('ButchersFetish', '도살자의 페티쉬')
             .replace('StormAmulet', '폭풍의 목걸이')
             .replace('VengeanceIdol', '복수의 우상')
             .replace('SoulAnchor', '영혼의 닻')
             .replace('ScavengersBauble', '고철 수집가의 싸구려 보석')
             .replace('HeartSeeker', '심장 추적기')
             .replace('MothersRing', '어머니의 반지')
             .replace('PillarOfStone', '돌 기둥')
             .replace('RingOfEvasion', '회피의 반지')
             .replace('Sagestone', '현자의 돌')
             .replace('BraidedThorns', '꼬은 가시')
             .replace('RootCirclet', '뿌리의 관')
             .replace('LeechEmber', '거머리 잉걸불')
             .replace('HuntersHalo', '사냥꾼의 광륜')
             .replace('GravityStone', '중력의 돌')
             .replace('EzlansBand', '에즐란의 띠')
             .replace('BandOfStrength', '힘의 띠')
             .replace('JewelOfTheBlackSun', '검은 태양의 보석')
             .replace('BloodFont', '피의 서약')
             .replace('DevouringLoop', '삼켜지는 고리')
             .replace('RazorStone', '날카로운 돌')
             .replace('StoneOfBalance', '균형의 돌')
             .replace('KeepersRing', '문지기의 반지')
             .replace('HuntersBand', '사냥꾼의 띠')
             .replace('CelerityStone', '쾌속의 돌')
             .replace('GuardiansRing', '수호자의 반지')
             .replace('HeartOfTheWolf', '늑대의 심장')
             .replace('HuntersHideout', '사냥꾼의 은신처')
             .replace('TotemFather', '토템 아범')
             .replace('Ruins', '유적')
             .replace('Flautist', '판 연주자')
             .replace('StuckMerchant', '꼼짝않는 상인')
             .replace('TheElfQueen', '엘프 여왕의 처소')
             .replace('OldManAndConstruct', '황무지 상인')
             .replace('Monolith', '모놀리스')
             .replace('ArmorVault', '아카리 금고')
             .replace('Settlement', '안식처')
             .replace('AcesCoin', '이상한 동전')
